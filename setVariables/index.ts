...
async function run() {
    ...
    try {
        ...
        const releaseId: string = tl.getVariable("RELEASE_RELEASEID");
        const variableName: string = tl.getInput('variableName', true);
        const variableValue: string = tl.getInput('variableValue', true);
